...
import { resolveInstallationSecret } from "../apps/web/src/lib/hermes/installation-secrets";
...
async function backupCommand(
  ...
  const secret = await resolveInstallationSecret("service", installation.installationKey);
