      ...
      <div className="min-w-0 space-y-5">
        ...
        <Tabs defaultValue="overview">
          ...
          <TabsContent className="grid gap-4 pt-4" value="security">
            ...
            {/* Condition sur l'origine, pas sur le transport : une installation enrôlée
                se renouvelle de la même façon en direct et en relay. */}
            {installation.origin === "remote_existing" && canConfigureRuntime(access.role) ? <Card><CardHeader><CardTitle>Rotation d’identité</CardTitle></CardHeader><CardContent><RotateRelayIdentity endpoint={endpoint} /></CardContent></Card> : null}
          </TabsContent>
