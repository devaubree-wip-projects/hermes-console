      ...
      <LegalArticle>
        <LegalSection title="Responsable de traitement">
          <p>
            ...
            <CompanyField name="raisonSociale" />, dont le siège est situé{" "}
            <CompanyField name="adresse" />.
          </p>
        </LegalSection>
        ...
        <LegalSection title="Durée de conservation">
          <p>
            ...
            archivées selon les délais suivants : <CompanyField name="dureesConservation" />.
          </p>
        </LegalSection>
        ...
        <LegalSection title="Destinataires et sous-traitants">
          <p>
            ...
            (hébergement, infrastructure) : <CompanyField name="sousTraitants" />. Aucune donnée
        ...
        <LegalSection title="Vos droits">
          <p>
            ...
            {/* Une micro-entreprise n'a pas l'obligation de désigner un DPO :
                annoncer ce poste laisserait croire à une fonction inexistante. */}
            {" "}Pour exercer ces droits, contactez-nous à l&apos;adresse{" "}
            <CompanyField name="contactDroits" />.
          </p>
        </LegalSection>
