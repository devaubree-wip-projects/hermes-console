...
import { LegalArticle, LegalSection } from "../_components/legal-article";
    ...
    <div className="space-y-8">
      ...
      <LegalArticle>
        ...
        <LegalSection title="5. Prix">
          <p>
            Le service est facturé <strong>{pricing.miseEnService}</strong> à la mise en service, puis{" "}
            <strong>{pricing.mensuel} par mois</strong>. La consommation des modèles d&apos;intelligence
            artificielle n&apos;est pas comprise : elle est {pricing.inference}.
          </p>
          <p>
            Les prix sont exprimés en euros. L&apos;éditeur relevant du régime de la franchise en base
            de TVA, celle-ci n&apos;est pas applicable (article 293 B du code général des impôts).
          </p>
        </LegalSection>
