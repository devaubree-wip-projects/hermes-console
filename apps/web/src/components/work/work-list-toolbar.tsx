        ...
        >
          <div className="space-y-4 p-4">
            ...
            <div className="grid grid-cols-2 gap-2.5 md:grid-cols-4">
              <Select value={current.get("status") ?? "all"} onValueChange={(value) => update({ status: value === "all" ? "" : value })}><SelectTrigger className="w-full" aria-label="Filtrer par statut"><SelectValue /></SelectTrigger><SelectContent><SelectItem value="all">Tous les statuts</SelectItem><SelectItem value="backlog">Backlog</SelectItem><SelectItem value="todo">Prêt</SelectItem><SelectItem value="in_progress">Actif</SelectItem><SelectItem value="blocked">Bloquées</SelectItem><SelectItem value="review">En revue</SelectItem><SelectItem value="done">Terminées</SelectItem><SelectItem value="cancelled">Annulées</SelectItem></SelectContent></Select>
