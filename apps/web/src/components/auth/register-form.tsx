  ...
  return (
    <Card>
      <CardHeader>
        ...
        {/* Le dire avant le formulaire : une adresse non invitée est refusée à
            l'envoi, et découvrir la règle après avoir tout saisi est pénible. */}
        <CardDescription>
          La création de compte se fait sur invitation. Utilisez l’adresse à laquelle vous avez été
          invité.
        </CardDescription>
      </CardHeader>
      <CardContent>
