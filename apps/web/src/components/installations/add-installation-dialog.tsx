    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[85dvh] overflow-y-auto sm:max-w-[38rem]">
        <DialogHeader>
          ...
          <DialogDescription>
            Enrôler donne à l’installation une identité et un secret qui lui sont
            propres. Connecter ne convient qu’à un Edge hérité, qui dérive encore
            ses secrets du secret de service de la Console.
          </DialogDescription>
        </DialogHeader>
        {/* Enrôler par défaut : c'est le seul chemin qui donne un secret révocable
