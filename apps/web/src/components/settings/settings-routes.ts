...
export const SETTINGS_PANELS = [
  ...
  },
  {
    ...
    icon: WrenchIcon,
    section: "Conversation",
    keywords: ["tools", "capacités", "toolsets", "runtime", "shell", "fichiers"],
  },
  {
    id: "mcp",
    label: "Connecteurs",
    icon: PlugZapIcon,
    section: "Conversation",
    keywords: ["mcp", "connecteur", "serveur", "catalogue", "intégration", "externe", "outils"],
  },
  {
    id: "documents",
    label: "Documents",
  ...
  },
  {
    ...
    section: "Espace de travail",
    keywords: ["env", "smtp", "email", "réglages", "configuration", "déploiement"],
  },
] as const
...
export function isWideSettingsPanel(panel: SettingsPanelId) {
  return panel === "models" || panel === "tools" || panel === "mcp"
}
