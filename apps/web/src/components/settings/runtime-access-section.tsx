...
export function RuntimeAccessSection({
  ...
  return (
    <div className="space-y-8">
      <MachineAccessSummary access={access} toolsHref={toolsHref} integrationsHref={integrationsHref} />
      {canEdit && profile ? (
      ...
      <SettingsRow
        ...
        description={(
          <>
            ...
            <Link href={integrationsHref} className="underline underline-offset-2">Gérer les intégrations</Link>.
          </>
        )}
        control={(
          <div className="flex max-w-[22rem] flex-wrap justify-end gap-1.5">
