  ...
  function buildRegisterUser() {
    ...
    const registerUser = createRegisterUser({
      repository: {
        ...
        // Ce bloc porte sur l'acceptation des CGU : l'adresse est réputée
        // invitée pour que la garde d'invitation ne masque pas ce qu'il teste.
        // La garde elle-même est couverte dans `register-user.test.ts`.
